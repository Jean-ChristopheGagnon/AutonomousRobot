...
public class USLocalizer {
	...
	if(corner == 2)
		odo.setPosition(new double[] {320.28, -15, 135}, new boolean[]{true, true, true}); 
	if(corner == 3)
		odo.setPosition(new double[] {320.28, 320.28, 225}, new boolean[]{true, true, true}); 
	if(corner == 4)
		odo.setPosition(new double[] {-15, 320.28, 315}, new boolean[]{true, true, true}); 
