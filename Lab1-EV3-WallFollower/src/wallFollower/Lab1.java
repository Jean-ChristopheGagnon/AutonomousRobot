...
// Main entry point - instantiate objects used and set up sensor
	...
	public static void main(String [] args) {
		...
		BangBangController bangbang = new BangBangController(leftMotor, rightMotor, usMotor, bandCenter, bandWidth, motorLow, motorHigh);
		PController p = new PController(leftMotor, rightMotor, usMotor, bandCenter, bandWidth);
